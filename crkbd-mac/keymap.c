...
#define C_RGHT  G(KC_RGHT)      // control(word) right
#define C_LEFT  G(KC_LEFT)      // control(word) left
#define C_CUT   G(KC_X)
#define C_PSTE  G(KC_V)
#define C_COPY  G(KC_C)
#define C_UNDO  G(KC_Z)

// Window Manager (MacOS)
#define WM_LEFT  C(KC_LEFT)
#define WM_MONL  G(S(KC_LEFT))
#define WM_RGHT  C(KC_RGHT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LGUI,   MO(1),   MO(4),     KC_SPC,   MO(2), KC_RCTL
                                      //`--------------------------'  `--------------------------'
  ),
  // Navigation Layer
  [1] = LAYOUT_split_3x6_3(
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
       KC_GRV,  C_UNDO,   C_CUT,  C_COPY,  C_PSTE, XXXXXXX,                      XXXXXXX, KC_PGUP,  KC_UP,  KC_PGDN, XXXXXXX,  KC_DEL,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      XXXXXXX, XXXXXXX, KC_ASTR, KC_PLUS, KC_MINS,  KC_EQL,                      XXXXXXX, KC_LBRC, KC_DQUO, KC_RBRC, KC_PIPE, XXXXXXX,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
