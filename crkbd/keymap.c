...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LGUI,   MO(3),   MO(1),      MO(1),   MO(5), KC_RCTL
                                      //`--------------------------'  `--------------------------'
  ),
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      XXXXXXX, C(KC_Z), C(KC_X), C(KC_C), C(KC_V),WM_SC_TG,                      XXXXXXX, KC_PGUP,   KC_UP, KC_PGDN, XXXXXXX, KC_RALT,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      WM_PGUP,  KC_F12, WM_LEFT, WM_CNTR, WM_RCTR,WM_SC_VW,                      KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT,  KC_END, KC_RCTL,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      WM_PGDN, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, G(KC_R),                      XXXXXXX,  C_LEFT, XXXXXXX,  C_RGHT, XXXXXXX, KC_RSFT,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          _______, _______,   MO(2),      MO(2), _______, _______
                                      //`--------------------------'  `--------------------------'
  ),
