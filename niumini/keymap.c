...
[_L1] = LAYOUT_planck_mit(
  KC_GRV,  G(KC_C), WM_LCENTER, WM_RCENTER,    G(S(KC_ESC)),   XXXXXXX,      _______, KC_PGUP,    KC_UP,         KC_PGDN,    _______,  _______,
  _______, KC_LGUI,    KC_LALT,    KC_LCTL,    KC_LSFT,        C(KC_ESC),    KC_HOME, KC_LEFT,    KC_DOWN,       KC_RGHT,    KC_END,   _______,
...
[_L2] = LAYOUT_planck_mit(
 ...
 G(KC_PGUP), _______,   _______,  _______,    _______,  A(KC_F12),       _______, KC_4,    KC_5,    KC_6,    KC_MINS, _______,
