...
[_RAISE] = LAYOUT_planck_mit(
  ...
  _______, _______,  _______, KC_UNDS, KC_MINS, S(KC_QUOT), KC_PIPE, KC_LABK, KC_LPRN, KC_LBRC, KC_LCBR, _______,
  _______, G(KC_Z),  G(KC_X), G(KC_C), G(KC_V), KC_QUOT,    KC_BSLS, KC_RABK, KC_RPRN, KC_RBRC, KC_RCBR, _______,
...
[_MACNAV] = LAYOUT_planck_mit(
 ...
 _______, KC_LCTL, KC_LALT, XXXXXXX, KC_LSFT, _______, G(KC_LEFT), KC_LEFT,    KC_DOWN, KC_RGHT,    G(KC_RGHT), _______,
