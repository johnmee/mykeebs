...
MO(_LCTL),  KC_LALT,  KC_LGUI, MO(_NUM),  MO(_LEFT), KC_SPC,     MO(_RIGHT),    MO(_FUNC), KC_RGUI, KC_RALT, KC_RCTL
),
...
[_LEFT] = LAYOUT_planck_mit(
 ...
 _______,   _______, _______, _______, KC_LCTL, KC_BSPC,          _______,    _______,       A(KC_F12),  C(KC_F5), _______
),

[_LCTL] = LAYOUT_planck_mit(
  _______, _______, KC_PGUP,    KC_UP,    KC_PGDN, _______, _______, KC_7,    KC_8,    KC_9,    KC_PAST, _______,
  _______, KC_HOME, KC_LEFT,    KC_DOWN, KC_RIGHT, KC_END,  _______, KC_4,    KC_5,    KC_6,    KC_MINS, _______,
...
[_RIGHT] = LAYOUT_planck_mit(
  ...
  _______,   S(KC_QUOT), KC_QUOT,    KC_UNDS,  KC_MINS,     KC_EQL,   G(KC_TAB),     WM_LCENTER, G(KC_PGDN),  WM_RCENTER, KC_PIPE, _______,
  _______,    TD_PRN,     TD_BRC,     TD_CBR,   KC_PLUS,    KC_ASTR,  G(S(KC_ESC)),  G(KC_R),    G(KC_C),     G(S(KC_F)), KC_BSLS, _______,
  _______,    _______,    _______,    _______,  _______,    KC_DEL,                  _______,    _______,     _______,    _______, _______
),

[_NUM] = LAYOUT_planck_mit(
  _______, _______, _______,    G(KC_PGUP),    _______, _______, _______, KC_7,    KC_8,    KC_9,    KC_PAST, _______,
  _______, _______, WM_LCENTER, G(KC_PGDN), WM_RCENTER, _______, _______, KC_4,    KC_5,    KC_6,    KC_MINS, _______,
  _______, _______, _______,    _______,       _______, _______, _______, KC_1,    KC_2,    KC_3,    KC_PPLS, _______,
  _______, _______, _______,    _______,       _______, _______,          KC_0,    KC_0,    KC_DOT,  KC_EQL,  _______
),
...
[_ADJUST] = LAYOUT_planck_mit(
 _______, _______, S(KC_PSCR), G(KC_L),  _______, _______, _______,    _______,   RGB_HUD,  RGB_SAD, RGB_VAD, _______,
